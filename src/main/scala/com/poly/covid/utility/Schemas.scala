...
class Schemas extends Serializable {
  ...
  def covidStruct(): StructType = {
    StructType(Seq(
      ...
      StructField("us_confirmed_county", IntegerType, true),
      StructField("deaths", IntegerType, true),
      StructField("us_deaths_county", IntegerType, true),
      StructField("recovered", IntegerType, true),
      StructField("us_recovered_county", IntegerType, true),
      StructField("active", IntegerType, true),
      StructField("us_active_county", IntegerType, true),
